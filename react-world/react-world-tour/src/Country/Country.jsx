...
// const passWithParams =
  ...
  return (
    <div  className={`border-gray-900 border-2 ${visited ? 'bg-lime-400 text-white ' : ''} `}>
      <h3>Name: {name.common}</h3>
      ...
      <div  className= {`${visited ? 'bg-red-400 text-black px-4 py-2 ' : 'bg-green-400 text-white  px-4 py-2 cursor-pointer'}`} disabled={visited}
